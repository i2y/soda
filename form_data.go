// This file is taken verbatim from github.com/pocketbase/pocketbase/plugins/jsvm.
...
//
// Only the package name differs from upstream (soda instead of jsvm)
// so the file can coexist with Soda's other plugin sources.
